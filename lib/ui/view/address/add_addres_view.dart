...
class AddAddressView extends StatefulWidget {
  ...
  AddAddressView(this.previousAddresses);
  _Add createState() => _Add();
}

class _Add extends State<AddAddressView> {
                      ...
                      onTap: () {
                        ...
                        _navigationService
                          ...
                          if (value is List) {
                            ...
                            final coordinates =
                            new geoCoder.Coordinates(value[0], value[1]);
...
//        padding: EdgeInsets.symmetric(vertical: verticalSpacing),
  ...
  _continueButton() {
    return _loader?Container(child: Center(child: CircularProgressIndicator(),),):FlatButton(
      child: Container(
