...
class ProductsView extends StatefulWidget {
  String index;
  ProductsView(this.index);
  _Categories createState() => _Categories();
}

class _Categories extends State<ProductsView> {
    ...
    return ViewModelBuilder.reactive(
        ...
        builder: (context, ProductsViewModel model, child) {
          return Scaffold(
              ...
              appBar: customAppBarWithTitle('Products', model.count,model),
  ...
  _categoryCard(Product product, ProductsViewModel model) {
    return Stack(
      children: [
        Container(
