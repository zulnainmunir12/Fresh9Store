...
class KarachiBiryani extends StatefulWidget {
  _KarachiBiryani createState() => _KarachiBiryani();
}

class _KarachiBiryani extends State<KarachiBiryani> {
              ...
              Column(
                ...
                children: [
                  Text(
                    'Best Deals',
                    style: TextStyle(
                        color: AppColor.primaryColor, fontSize: FontSize.xxxl),
                  ),
                  Text(
                    'Deal 1',
                    style: TextStyle(
                        color: AppColor.blackColor, fontSize: FontSize.xxl),
                  ),
                  Text(
                    'Half chicken biryani 1 chicken\npiece, salad , cold drink',
                    style: TextStyle(
                        color: AppColor.lightestGrey, fontSize: FontSize.l),
                  ),
                  Row(
                    children: [
                      Text(
                  ...
                  Container(width: MediaQuery.of(context).size.shortestSide*0.4,
