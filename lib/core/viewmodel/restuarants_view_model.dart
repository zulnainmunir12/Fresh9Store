...
class RestuarantsViewModel extends CustomBaseViewModel {
...
//    }
  ...
  getStores(LocationData _location) async {
    ...
    if (_location.latitude != null) {
      BaseModel response = await _api.getRestuarants(
      ...
      if (response.serverError == null) {
        ...
        if (_stores.length != 0) {
          await getAds("restuarant", _location.latitude, _location.longitude);
